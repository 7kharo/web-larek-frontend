...
- _id: string - id представленного товара
- _title: string - название представленного товара
- _description: string - описание представленного товара
- category: ProductType - категория, к которой относится товар
- _price: number | null - цена товара (товар может быть бесценным)
